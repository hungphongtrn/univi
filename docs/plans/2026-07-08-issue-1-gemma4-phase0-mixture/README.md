...
- **Next Up:** Phase 2 — Smoke Training (pending Phase 1 completion)
...
2. [phase-01-preprocessing-pipeline.md](./phase-01-preprocessing-pipeline.md) — Only the phase you're implementing (15 min)
